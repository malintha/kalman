...
public class MatrixSetter {
    ...
    public void readFile(){
        try {
            InputStream is = MatrixSetter.class.getResourceAsStream("mathKalman.csv");
        ...
        switch (matrixNumber) {
            ...
            case 9:
                ...
                if(rowNum == 1 && t[0]==0){
                    ...
                    Number r = t[0];
                    u = new ArrayRealVector(r.intValue());
                }
                else if(rowNum > 1){
                    u.setEntry(rowNum-2,t[0]);
                }
            default :
                //no other cases
                break;
