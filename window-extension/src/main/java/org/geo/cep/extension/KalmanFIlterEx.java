...
public class KalmanFIlterEx {
    ...
    public void setgpshm(double lat, double lon,double course,double velocity, double Vx, double Vy){
        double dX,dY;
        double[] dxy;
    ...
    public void doKalman(double lat, double lon, double course, double velocity){
...
//	set in config
    ...
    public RealVector getEstimateVector(){
